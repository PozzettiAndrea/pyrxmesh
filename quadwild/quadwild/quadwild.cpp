...
int actual_main(int argc, char* argv[])
{
    ...
    std::cout << "[STEP] Step 1 complete: " << trimesh.vn << "V, " << trimesh.fn << "F" << std::endl;
    if (stopAfterStep == 1) {
        return 0;
    }
    ...
    std::cout << "[STEP] Step 2 complete: tracing done" << std::endl;
    if (stopAfterStep == 2) {
        return 0;
    }
    ...
    std::cout << "[STEP] Step 3 complete: " << quadmesh.vn << "V, " << quadmesh.fn << "F (quads)" << std::endl;
